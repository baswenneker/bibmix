...
module Bibmix
	module Bibsonomy
		...
		class TitleQueryMergerError < QueryMergerError
		end
		
		class TitleQueryMergerInvariantError < TitleQueryMergerError
		end
	
		class TitleQueryMergerEmptyQueryResultError < TitleQueryMergerError
		end
